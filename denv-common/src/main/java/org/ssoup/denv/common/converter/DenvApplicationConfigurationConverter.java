...
//import org.ssoup.denv.common.model.config.application.DenvApplicationConfiguration;
 ...
 */
@Service
public class DenvApplicationConfigurationConverter extends AbstractDenvYamlMessageConverter<ApplicationConfiguration> {
    private static final Logger logger = LoggerFactory.getLogger(DenvApplicationConfigurationConverter.class);
