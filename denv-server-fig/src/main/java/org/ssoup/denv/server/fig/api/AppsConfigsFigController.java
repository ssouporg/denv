 ...
 */
@RestController
@RequestMapping(AppsConfigsFigController.PATH)
public class AppsConfigsFigController extends AbstractController {
    ...
    public static final String PATH = "/api/v1/apps/configs/fig";
    ...
    public @ResponseBody ResponseEntity<String> createApplicationFromFigConfiguration(
        ...
        responseHeaders.set("Location", AppsConfigsFigController.PATH + "/" + appConfig.getName());
