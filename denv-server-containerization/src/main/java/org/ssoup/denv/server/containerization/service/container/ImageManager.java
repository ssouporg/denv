...
public interface ImageManager {
    Image findImage(EnvironmentConfiguration envConf, String version, ImageConfiguration imageConf) throws DenvException;
    Image findImage(String imageName, ImageConfiguration imageConf) throws DenvException;
    Image findOrBuildImage(EnvironmentConfiguration envConf, String version, ImageConfiguration imageConf) throws DenvException;
}
